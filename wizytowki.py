...
def create_contacts(rodzaj, ilosc):
    ...
    if rodzaj == 'priv':
        return [BaseContact(imie=faker.first_name(), nazwisko=faker.last_name(), telefon_priv=faker.phone_number(),
                            email=faker.company_email()) for _ in range(ilosc)]

    elif rodzaj == 'biz':
        return [BusinessContact(imie=faker.first_name(), nazwisko=faker.last_name(), stanowisko=faker.job(),
                                nazwa_firmy=faker.company(), email=faker.company_email(),
                                telefon_priv=faker.phone_number(), telefon_business=faker.phone_number()) for _ in
                range(ilosc)]
